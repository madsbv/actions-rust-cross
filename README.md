...
| `toolchain-action-rev`  | string                      | no        | The revision of the dtolnay/rust-toolchain action to use. Defaults to "master". Note that this does not set the toolchain or rust version, but merely allows for pinning the Github Action version to use.                                                                                                                                    |
...
| `cache-cross-binary`    | string                      | no        | Cache the cross binary if one is installed. This is primarily for use in tests of this action.                                                                                                                                                                                                                                                |
| `cache-action-rev`      | string                      | no        | The revision of the actions/cache action to use for caching the cross binary. Defaults to v4.                                                                                                                                                                                                                                                 |
...
| `use-rust-cache`        | boolean (`true` or `false`) | no        | Whether or not to use [the `Swatinem/rust-cache@v2` action](https://github.com/Swatinem/rust-cache). This defaults to true.                                                                                                                                                                                                                   |
...
| `rust-cache-action-rev` | string                      | no        | The revision of the Swatinem/rust-cache action to use. Defaults to v2.                                                                                                                                                                                                                                                                        |
